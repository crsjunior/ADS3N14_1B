...
public class Dijkstra
{
	...
	private Set<Vertice> visitados;           // vertices visitados.
	private Set<Vertice> naoVisitados;        // vertices nao visitados.
	private Map<Vertice, Vertice> anteriores; // 
	private Map<Vertice, Double> distancias;  // distancias das arestas.
	...
	/**
	 * Executa o algoritmo de Dijkstra, procurando o melhor caminho entre dois vertices e
	 * retornando uma lista com todos os passos do caminho.
	 * @param origem Vertice de origem.
	 * @param destino Vertice de destino.
	 * @return Se existir uma caminho, retorna uma lista contendo os passos do caminho encontrado,
	...
	{
		// AQUI TEM QUE SER INCLUIDO O CUSTO, NAO SABEMOS AINDA EXATAMENTO COMO PESA-LO!!!
